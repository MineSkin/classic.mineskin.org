...
<footer class="footer" ng-init="refreshStats()" style="padding-bottom: 20px;">
    ...
    <div class="container">
        <div class="pull-left">
            <a href="https://mineskin.org/stats" style="color: #666666;"><span title="{{stats.unique}} unique, {{stats.private}} private">{{stats.total}}</span><strong> Skulls generated by </strong><span>{{stats.accounts}}</span><strong> accounts, </strong><span>{{stats.lastDay}}</span><strong> in the past 24 hours</a> | <a href="https://inventivetalent.org/contact/" target="_blank">Donate an account to speed things up!</a></strong>
        </div>
