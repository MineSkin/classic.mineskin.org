...
<a href="https://github.com/MineSkin">
...
<footer class="footer" ng-init="refreshStats()" style="padding-bottom: 20px;">
    ...
    <div class="container">
        <div class="pull-left">
            <a href="https://mineskin.org/stats" style="color: #666666;"><span title="{{stats.unique | number}} unique, {{stats.private | number}} private">{{stats.total | number}}</span><strong> Skulls generated by </strong><span>{{stats.accounts | number}}</span><strong> accounts, </strong><span>{{stats.lastDay | number}}</span><strong> in the past 24 hours</a> | <a href="https://github.com/MineSkin/mineskin.org/wiki/Account-Contribution" target="_blank">Donate an account to speed things up!</a></strong>
        </div>
